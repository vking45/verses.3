...
function Feed() {
    ...
    <div class="flex flex-wrap -m-4">
      <div class="p-4 lg:w-1/3">
        <div class="h-full bg-thor bg-opacity-75 px-8 pt-8 pb-12 rounded-xl overflow-hidden text-start relative">
          ...
          <h2 class="tracking-wide text-md title-font font-bold text-secondary bg-loki rounded-2xl mb-2 w-fit px-4 py-0.5">Creator</h2>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 7.125C2.25 6.504 2.754 6 3.375 6h6c.621 0 1.125.504 1.125 1.125v3.75c0 .621-.504 1.125-1.125 1.125h-6a1.125 1.125 0 01-1.125-1.125v-3.75zM14.25 8.625c0-.621.504-1.125 1.125-1.125h5.25c.621 0 1.125.504 1.125 1.125v8.25c0 .621-.504 1.125-1.125 1.125h-5.25a1.125 1.125 0 01-1.125-1.125v-8.25zM3.75 16.125c0-.621.504-1.125 1.125-1.125h5.25c.621 0 1.125.504 1.125 1.125v2.25c0 .621-.504 1.125-1.125 1.125h-5.25a1.125 1.125 0 01-1.125-1.125v-2.25z" />
      ...
      <div class="p-4 lg:w-1/3">
      <div class="h-full bg-romeo bg-opacity-75 px-8 pt-8 pb-12 rounded-xl overflow-hidden text-start relative">
          <h1 class=" text-3xl font-medium text-primary mb-3">Raclette Blueberry Nextious Level</h1>
          <h2 class="tracking-wide text-md title-font font-bold text-secondary bg-juliet rounded-2xl mb-2 w-fit px-4 py-0.5">Creator</h2>
          <hr class="h-px opacity-50 my-1 bg-juliet border-0 "></hr>
          <h2 class="tracking-widest text-md title-font font-semibold text-primary rounded-lg  w-fit px-4 py-0.5">Touch of wood | Assesnce </h2>
          <hr class="h-px opacity-50 my-1 bg-juliet border-0 "></hr>
          <p class="leading-relaxed mb-3 text-primary text-xl">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
          <div class="text-center mt-2 leading-none flex justify-center absolute bottom-0 left-0 w-full py-4 text-primary">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 7.125C2.25 6.504 2.754 6 3.375 6h6c.621 0 1.125.504 1.125 1.125v3.75c0 .621-.504 1.125-1.125 1.125h-6a1.125 1.125 0 01-1.125-1.125v-3.75zM14.25 8.625c0-.621.504-1.125 1.125-1.125h5.25c.621 0 1.125.504 1.125 1.125v8.25c0 .621-.504 1.125-1.125 1.125h-5.25a1.125 1.125 0 01-1.125-1.125v-8.25zM3.75 16.125c0-.621.504-1.125 1.125-1.125h5.25c.621 0 1.125.504 1.125 1.125v2.25c0 .621-.504 1.125-1.125 1.125h-5.25a1.125 1.125 0 01-1.125-1.125v-2.25z" />
      ...
      <div class="p-4 lg:w-1/3">
      <div class="h-full bg-bachira bg-opacity-75 px-8 pt-8 pb-12 rounded-xl overflow-hidden text-start relative">
          <h1 class=" text-3xl font-medium text-primary mb-3">Raclette Blueberry Nextious Level</h1>
          <h2 class="tracking-wide text-md title-font font-bold text-secondary bg-isagi rounded-2xl mb-2 w-fit px-4 py-0.5">Creator</h2>
          <hr class="h-px opacity-50 my-1 bg-isagi border-0 "></hr>
          <h2 class="tracking-widest text-md title-font font-semibold text-primary rounded-lg  w-fit px-4 py-0.5">Touch of wood | Assesnce </h2>
          <hr class="h-px opacity-50 my-1 bg-isagi border-0 "></hr>
          <p class="leading-relaxed mb-3 text-primary text-xl">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
          <div class="text-center mt-2 leading-none flex justify-center absolute bottom-0 left-0 w-full py-4 text-primary">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 7.125C2.25 6.504 2.754 6 3.375 6h6c.621 0 1.125.504 1.125 1.125v3.75c0 .621-.504 1.125-1.125 1.125h-6a1.125 1.125 0 01-1.125-1.125v-3.75zM14.25 8.625c0-.621.504-1.125 1.125-1.125h5.25c.621 0 1.125.504 1.125 1.125v8.25c0 .621-.504 1.125-1.125 1.125h-5.25a1.125 1.125 0 01-1.125-1.125v-8.25zM3.75 16.125c0-.621.504-1.125 1.125-1.125h5.25c.621 0 1.125.504 1.125 1.125v2.25c0 .621-.504 1.125-1.125 1.125h-5.25a1.125 1.125 0 01-1.125-1.125v-2.25z" />
      ...
      <div class="p-4 lg:w-1/3">
      <div class="h-full bg-walt bg-opacity-75 px-8 pt-8 pb-12 rounded-xl overflow-hidden text-start relative">
          <h1 class=" text-3xl font-medium text-primary mb-3">Raclette Blueberry Nextious Level</h1>
          <h2 class="tracking-wide text-md title-font font-bold text-secondary bg-jesse rounded-2xl mb-2 w-fit px-4 py-0.5">Creator</h2>
          <hr class="h-px opacity-50 my-1 bg-jesse border-0 "></hr>
          <h2 class="tracking-widest text-md title-font font-semibold text-primary rounded-lg  w-fit px-4 py-0.5">Touch of wood | Assesnce </h2>
          <hr class="h-px opacity-50 my-1 bg-jesse border-0 "></hr>
          <p class="leading-relaxed mb-3 text-primary text-xl">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
          <div class="text-center mt-2 leading-none flex justify-center absolute bottom-0 left-0 w-full py-4 text-primary">
